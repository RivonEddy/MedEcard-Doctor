...
import com.medecard.user.medecard_doctor.ViewRecordsConsActivity;
...
public class RecyclerViewAdapter_Consultations extends RecyclerView
        .Adapter<RecyclerViewAdapter_Consultations.MyViewHolder> {

    Intent intent;

    Context mContext;
    List<Consultations> mData;

    public RecyclerViewAdapter_Consultations(Context mContext, List<Consultations> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        vHolder.recycler_cons_drec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(mContext, ViewRecordsConsActivity.class);
